/**
 * WebBookingRequestDemoInformation.java
 *
...
public class WebBookingRequestDemoInformation  implements java.io.Serializable {
    private com.rightrez.CreatePNRRequest pnrRequestInformation;

    public WebBookingRequestDemoInformation() {
    }
    ...
    /**
     * Gets the pnrRequestInformation value for this WebBookingRequestDemoInformation.
     * 
    ...
    /**
     * Sets the pnrRequestInformation value for this WebBookingRequestDemoInformation.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof WebBookingRequestDemoInformation)) return false;
        WebBookingRequestDemoInformation other = (WebBookingRequestDemoInformation) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(WebBookingRequestDemoInformation.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rightrez.com/", ">WebBookingRequestDemoInformation"));
